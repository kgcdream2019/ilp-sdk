...
import { XmrdPaychanBaseUplink } from './settlement/xmrd-paychan';
...
export declare type BaseUplinks = (LndBaseUplink | MachinomyBaseUplink | XrpPaychanBaseUplink | XmrdPaychanBaseUplink) & BaseUplink;
...
export declare const createUplink: (state: State, readyCredential: ReadyCredentials, assetType?: "DAI" | "BTC" | "ETH" | "XRP" | "XMRD" | undefined) => Promise<ReadyUplinks>;
