...
exports.connectBaseUplink = (credential) => {
    switch (credential.settlerType) {
        ...
        case engine_1.SettlementEngineType.XmrdPaychan:
            return xmrd_paychan_1.XmrdPaychan.connectUplink(credential);
        // end
    }
};
...
exports.depositToUplink = (uplink) => {
    switch (uplink.settlerType) {
        ...
        /*newly added code for xmrd*/
        case engine_1.SettlementEngineType.XmrdPaychan:
            return xmrd_paychan_1.XmrdPaychan.deposit(uplink);
        /*end*/
    }
};
exports.withdrawFromUplink = (uplink) => {
    switch (uplink.settlerType) {
        ...
        /*newly added code for xmrd*/
        case engine_1.SettlementEngineType.XmrdPaychan:
            return xmrd_paychan_1.XmrdPaychan.withdraw(uplink);
        /*end*/
    }
};
/**
...
exports.getBaseBalance = (state) => async (uplink) => {
    ...
    switch (credential.settlerType) {
        ...
        case engine_1.SettlementEngineType.XmrdPaychan:
            ...
            return xmrd_paychan_1.XmrdPaychan.getBaseBalance(xmrdSettler, credential);
        /*end*/
    }
};
/**
