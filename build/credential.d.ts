...
import { UnvalidatedXmrdSecret, ValidatedXmrdSecret } from './settlement/xmrd-paychan';
export declare type CredentialConfigs = (ValidatedLndCredential | ValidatedEthereumPrivateKey | UnvalidatedXrpSecret | UnvalidatedXmrdSecret) & {
    readonly settlerType: SettlementEngineType;
};
export declare type ReadyCredentials = (ReadyLndCredential | ReadyEthereumCredential | ValidatedXrpSecret | ValidatedXmrdSecret) & {
    readonly settlerType: SettlementEngineType;
};
...
}, "ValidatedXmrdSecret">>) | ((state: State) => Promise<import("./types/util").Flavor<{
